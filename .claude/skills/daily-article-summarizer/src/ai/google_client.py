...
class GeminiSummarizer:
    ...
    def __init__(self):
        ...
        try:
            ...
            raise ValueError("google-genai 包未安装，请运行: uv add google-genai")
...
只输出JSON，不要包含其他说明或代码块标记。"""
        ...
        print(f"    Error: Gemini summarization failed after {max_retries} attempts")
        return None
